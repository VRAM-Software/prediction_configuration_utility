...
import { Content, ControlPanel, Button, FileInput, ChangeParamModal, SaveFileModal } from "./UI";
import "./AppOLD.css";
    ...
    if (e.target.files[0]) {
      ...
      ipcRenderer.on("finished-reading-conf", (event, arg) => {
        if (arg.notes) {
          ...
          console.error("Il file json inserito non è conforme allo standard dell'applicazione");
          this.setState({
            jsonFileInfo: null,
          });
        }
    ...
    return (
      <div className={styles["container"]}>
        ...
        <div className={styles["buttons-container"]}>
          <FileInput type='csv' onChange={this.loadData} isFileChosen={this.state.csvFileInfo} />
          <FileInput type='json' onChange={this.loadConf} isFileChosen={this.state.jsonFileInfo} />
