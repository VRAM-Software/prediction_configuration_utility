    ...
    return (
      <div className={styles["modal-container"]}>
        <div className={styles["modal-save-file"]}>
          ...
          <Input placeholder='Scrivi nome file .json' handleChange={this.props.change} />
          <FolderInput folderPath={this.props.userFolder} onClick={this.props.setFolder} />
          <div>
            <Button loading={false} loadingText={null} text='Chiudi' onClick={this.props.close} />
            <Button
              loading={false}
              loadingText={null}
              text='Salva Json'
        ...
        <div className={styles["modal-background"]} onClick={this.props.close} />
      </div>
    );
  }
}
    ...
    return (
      <div className={styles["modal-container"]}>
        <div className={styles["modal-set-param"]}>
          ...
          <div className={styles["modal-set-param-select-container"]}>{selects}</div>
    ...
    return (
      <div className={styles["resultPanel-container"]}>
        {this.props.qualityIndex && this.props.algorithmChosen === "svm" ? (
          <div className={styles["resultPanel-quality-index-container"]}>
            <h3>Indici di qualità</h3>
            <div>
              <SvmQualityIndex text='Precision' index={this.props.qualityIndex.precision} />
              <SvmQualityIndex text='Recall' index={this.props.qualityIndex.recall} />
            </div>
          </div>
        ) : null}
      </div>
